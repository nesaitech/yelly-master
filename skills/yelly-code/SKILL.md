...
description: |
  ...
  Invoke with /yelly-code or when user asks to fix, debug, review, refactor, or plan.
---
...
```
🔧 yelly-code: Preparing for [task description]
...
Example: `~/.claude/skills/yelly-master/bin/yelly-config get debug.max_attempts`
