...
description: |
  ...
  changelog management. Invoke with /yelly-team or when user asks about
...
# yelly-team — Collaboration & Documentation
...
```
🔧 yelly-team: Preparing for [task description]
...
- Common cross-module flows:
  ...
  - doc → review (review documentation accuracy) — cross mega-skill, load from ~/.claude/skills/yelly-master/modules/review/guide.md
...
Example: `~/.claude/skills/yelly-master/bin/yelly-config get doc.format`
